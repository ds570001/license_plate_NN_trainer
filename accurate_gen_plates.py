...
path = "/home/fizzer/ros_ws/src/2020T1_competition/enph353/enph353_gazebo/scripts/"
...
for i in range(0, N):
    ...
    #spot_w_plate = spot_w_plate[400:(spot_w_plate.shape[0]),:]
    ...
    #crop
    unlabelled = unlabelled[1252:1252+300,:]
    '''cv2.imshow("pic", unlabelled)
    cv2.waitKey(3000)
